...
function onLook(cid, thing, position, lookDistance)
    if isPlayer(thing.uid) and thing.uid ~= cid then
        doPlayerSetSpecialDescription(thing.uid, "\n[Frags: "..getPlayerFrags(thing.uid).."], [Mortes: "..getDeathsAndKills(thing.uid).."].\n[Dodge: "..math.max(0,(tonumber(getPlayerStorageValue(thing.uid, 98798644)) or 0)).."], [Critical: "..math.max(0,(tonumber(getPlayerStorageValue(thing.uid,48903)) or 0)).."].")
  elseif thing.uid == cid then
        doPlayerSetSpecialDescription(cid, "\n[Frags: "..getPlayerFrags(cid).."], [Mortes: "..getDeathsAndKills(cid).."].\n[Dodge: "..math.max(0,(tonumber(getPlayerStorageValue(cid, 98798644)) or 0)).."], [Critical: "..math.max(0,(tonumber(getPlayerStorageValue(cid,48903)) or 0)).."].") 
