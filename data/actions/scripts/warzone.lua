...
if getPlayerStorageValue(cid, 45699) > 0 then
	...
	elseif wz5 == 5 then
		...
		doPlayerSendTextMessage(cid,22,"Voc� j� pegou a recompensa da Warzone 2 nas ultimas 24 horas.")
	end
else
	doPlayerSendTextMessage(cid,22,"Voc� n�o concluiu a Warzone 2.")
end
...
if getPlayerStorageValue(cid, 45698) > 0 then
	...
	elseif wz5 == 5 then
		...
		doPlayerSendTextMessage(cid,22,"Voc� j� pegou a recompensa da Warzone 1 nas ultimas 24 horas.")
	end
else
	doPlayerSendTextMessage(cid,22,"Voc� n�o concluiu a Warzone 1.")
end
	return TRUE
end