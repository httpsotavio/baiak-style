...
if isPlayer(cid) and exhaustion.check(cid, storage) then
    doPlayerSendCancel(cid, "Este feitico esta em recarga elementar, voce tem que esperar "..(exhaustion.get(cid, storage)).." sem usar nenhum outro feitiço de elemento especial antes de lançar esse feitiço.")
    return false
end
exhaustion.set(cid, 45673, 60)
