local monsterPosition = {x = 156, y = 46, z = 7}
local lootBoostPosition = {x = 146, y = 47, z = 7}
local expBoostPosition = {x = 144, y = 47, z = 7}
...
function onThink()
  ...
  doSendAnimatedText(monsterPosition, "Boosted", 64)
  doSendMagicEffect(monsterPosition, 5)
  return true
end
