...
function onTime()
	local players_tp = getPlayersInArea({x= 165, y= 48, z= 7}, {x= 165, y= 48, z= 7}) -- Onde o teleport vai nascer
	if getGlobalStorageValue(722641) == -1 then
		...
		doCreateTeleport(1387, {x = 168, y = 54, z = 7}, bomberman.tpPos) -- Onde o teleport vai nascer e para onde o Player será levado
		setGlobalStorageValue(722641, 1)
		setGlobalStorageValue(722642, os.time()+120*60) -- EVITAR BUG COM DTT
		announce("O teleport para as arenas do Bomberman está aberto até as 14:00!", 10)
	else
