...
function isPlayerOnlineByGUID(id)
    local queryResult = db.storeQuery("SELECT `online` FROM `players` WHERE `id` = '"..id.."'")
    local result = result.getDataInt(queryResult, "online")
