exaltationForge = {
    ...
    message = {
        fail = "{Exaltation Forge} Você falhou em sua melhoria.",
        maxlevel = "{Exaltation Forge} O item %s já está no seu nível maximo.",
        downgrade = "{Exaltation Forge} Seu item %s regrediu para o nível +%s.",
        notupgradeable = "{Exaltation Forge} O item %s não pode ser melhorado.",
        tierdifferent= "{Exaltation Forge} Os itens precisam ter o mesmo nível de tier.",
        itemsdifferent = "{Exaltation Forge} Os itens precisam coincidir um com o outro.",
        toolrange = "{Exaltation Forge} Você só pode usar a forja com items de nível +%s-.",
        ...
        needitems = "{Exaltation Forge} Você precisa depositar 2 itens para que seja possível usar a alavanca.",
        success = "{Exaltation Forge} O item %s foi melhorado para o nível %s. Próximo nível com %s%% de change de ser melhorado.",
        successMaxLevel = "{Exaltation Forge} O item %s foi melhorado para o nível %s."
    },
}
