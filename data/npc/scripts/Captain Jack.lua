...
local travelNode = keywordHandler:addKeyword({"frostline"}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "Gostaria de voltar para Baiak City?"})
	travelNode:addChildKeyword({"yes"}, StdModule.travel, {npcHandler = npcHandler, premium = false, level = 0, cost = 30, destination = {x=174, y=75, z=7} })
	travelNode:addChildKeyword({"no"}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, reset = true, text = "We would like to serve you some time."})
