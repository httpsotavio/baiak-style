	advertisingBlock = ".com;.c om;.c o m;pontocom;.com.br;,com;.online;.ml;.tk;.net;.hopto;.info;.org;.zapto;.me;.ddns;.pl;.biz;,con;.con;.con.br;b@iak;b4i4k;b4iak;no-ip;servegame;-"

	ownerName = "Equipe Style"
	ownerEmail = ""
	url = "http://baiak-style.com"
	location = "Brazil"

	motd = "Bem Vindo(a) ao Baiak Style!!"
	serverName = "Style"
	loginMessage = "Bem Vindo(a) ao Baiak Style!!"
	...
	newPlayerSpawnPosX = 745
	newPlayerSpawnPosY = 43
	...
	fragsToBlackSkull = 999
	fragsSecondToBlackSkull = 9999
	...
	versionMin = 860
	versionMax = 860
	versionMsg = "Voce nao esta na vers�o atual, por favor atualize!"
	...
	mapAuthor = "Equipe Style"
	randomizeTiles = true
	houseDataStorage = "binary-tilebased"
	storeTrash = true
	cleanProtectedZones = true
	mapName = "BaiakMap.otbm"
